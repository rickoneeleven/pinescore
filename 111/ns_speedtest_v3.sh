...
do
	...
	wget https://novascore.io/111/ns_1GB.zip -o /dev/null &
        wget http://ipv4.download.thinkbroadband.com/1GB.zip -o /dev/null

	sleep 2
#	echo
#	echo
#	echo Aggregated download test from novascore.io
#	write_output download >> speedtest.log &
#	wget https://novascore.io/111/ns_1GB.zip -o /dev/null
#
#	sleep 2
...
#	sleep 2
	...
	echo
	echo
	echo Aggregated upload test to novascore.io
	write_output upload >> speedtest.log &
	sleep 1
	curl -T ns_1GB.zip ftp://novascore.io --user ftp_speedtest.novascore:ftp_speedtest.novascore 2>/dev/null
...
#	echo
#	echo
#	echo "+++++++++++++++++   none aggreagated novascore:"
#	wget -q --show-progress -O /dev/null https://novascore.io/111/ns_1GB.zip &
#	sleep 10
#	killall -q -s 9 wget
#	echo
#	echo
...
killall -q -s 9 tail
echo
echo " +++++++++++++++++   deleting script, if you'd like to run again, please pull the latest version from https://novascore.io/111/ns_speedtest_v3.sh"
echo " +++++++++++++++++   example one liner: wget https://novascore.io/111/ns_speedtest_v3.sh --no-check-certificate && chmod +x ns_speedtest_v3.sh && ./ns_speedtest_v3.sh eth1"
